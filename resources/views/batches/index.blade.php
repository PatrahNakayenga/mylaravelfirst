                        ...
                        <table class="table">
                            ...
                            @foreach($batches as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/batches/' . $item->id) }}" title="View courses"><button class="btn btn-info btn-sm"> <i class="fa fa-eye" aria-hidden="true"></i>View</button></a>
                                            <a href="{{ url('/batches/' . $item->id . '/edit') }}" title="Edit courses"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</button></a>
